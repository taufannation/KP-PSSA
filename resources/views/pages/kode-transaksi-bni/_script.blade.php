<script type="text/javascript">
    ...
    $('#data_form').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ asset('kode-transaksi-bni/store') }}",
            data: idata,
            processData: false,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                ...
                window.location.href = "{{ asset('kode-transaksi-bni') }}"
                out_load();
            },
    ...
    function edit_data(id) {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ asset('kode-transaksi-bni/edit') }}/" + id,
            data: {
                id: id,
                _token: token
            },
        ...
        $('#swal-update-button').click(function(e) {
            ...
            $.ajax({
                type: "PUT",
                dataType: "json",
                url: "{{ asset('kode-transaksi-bni/update') }}/" + id,
                data: {
                    _token: token,
                    kode: $('#kode_edit').val(),
                    nama: $('#nama_edit').val(),
    ...
    function show_data(id) {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ asset('kode-transaksi-bni/show') }}/" + id,
        ...
        swal({
            ...
            if (deleteFile) {
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ asset('/kode-transaksi-bni/destroy') }}/" + id,
