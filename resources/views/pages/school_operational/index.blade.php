...
@section('title','Dana Donatur')
@section('content')
<div class="section-header">
    <h1><i class="fa fa-credit-card"></i> Dana Donatur</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active">Dana Donatur</div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Dana Donatur</h4>
                    <div class="ml-auto">
