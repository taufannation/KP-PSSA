<!-- Modal -->
<div class="modal fade" id="tabunganbri_edit" data-backdrop="static" data-keyword="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <select name="kode_bri_id" id="kode_bri_id_edit" class="form-control">
                                    <option value="">- Pilih Kode Transaksi BRI -</option>
...
{{-- <script type="text/javascript">
        ...
        $('#form_edit').on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ asset('kodebri/update/'. $data->id) }}",
data: idata,
processData: false,
contentType: false,
cache: false,
...
window.location.href= "{{ asset('kodebri') }}"
out_load();
},
