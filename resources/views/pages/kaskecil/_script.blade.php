<script type="text/javascript">
        ...
        oTable = $('#datatable').DataTable({
            ...
            ajax: {
                ...
                "data": function(data) {
                    ...
                    data.mata_anggaran_id = $("#filter_mata_anggaran_id").val();
    ...
    document.getElementById('filter_mata_anggaran_id').addEventListener('change', function() {
        oTable.ajax.reload();
    });
    ...
    function edit_data(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#mata_anggaran_id_edit').val(data.data.mata_anggaran_id);
        ...
        $('#swal-update-button').click(function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    mata_anggaran_id: $('#mata_anggaran_id_edit').val(),
    ...
    function show_data(id) {
        $.ajax({
            ...
            success: function(data) {
                var nama_mata_anggaran = '';
                var kode_mata_anggaran = '';
                var kode_dan_mata_anggaran = '';
                var data_mata_anggaran = data.data.mata_anggaran;

                if (data_mata_anggaran.hasOwnProperty('kode')) {
                    kode_mata_anggaran = data_mata_anggaran['kode'];
                }

                if (data_mata_anggaran.hasOwnProperty('nama')) {
                    nama_mata_anggaran = data_mata_anggaran['nama'];
                }
                if (data_mata_anggaran.hasOwnProperty('kode')) {
                    kode_dan_mata_anggaran = '[' + data_mata_anggaran['kode'] + '] - ' + data_mata_anggaran['nama'];
                }
                ...
                $('#kode_dan_mata_anggaran_show').html(kode_dan_mata_anggaran);
