<script type="text/javascript">
    ...
    $('#data_form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                window.location.href = "{{ asset('tabungan-bni') }}";
                out_load();
            },
    ...
    function edit_data(id) {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ asset('tabungan-bni/edit') }}/" + id,
            data: {
                id: id,
                _token: token
            },
        ...
        $('#swal-update-button').click(function(e) {
            ...
            $.ajax({
                type: "PUT",
                dataType: "json",
                url: "{{ asset('tabungan-bni/update') }}/" + id,
                data: {
                    _token: token,
    ...
    function show_data(id) {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ asset('tabungan-bni/show') }}/" + id,
        ...
        swal({
            ...
            if (deleteFile) {
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ url('/tabungan-bni/destroy') }}/" + id,
