                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-auto mb-3">
                                    <a href="/kode-transaksi-bni" class="btn btn-success mt-2">Kode Transaksi</a>
                                </div>
                                ...
                                <div class="col-auto mb-3">
                                    <button type="button" class="btn btn-danger btn-filter-action mb-1" data-url="{{ route('tabungan-bni.print') }}">
                                        <i class="fa fa-file-pdf mr-1"></i>Print
                                    </button>
                                    <button type="button" class="btn btn-primary mb-1" data-toggle="modal" data-target="#tabungan-bni_create">
                                    ...
                                    <button type="button" class="btn btn-info btn-filter-action" data-url="{{ url('tabungan-bni/export') }}" data-toggle="tooltip" title="Export Excel">
...
@endsection
@push('js_internal')
@include('pages.tabungan-bni.modal.create')
@include('pages.tabungan-bni.modal.edit')
@include('pages.tabungan-bni.modal.show')
@include('pages.tabungan-bni.modal.import')
@include('pages.tabungan-bni._script')
@endpush