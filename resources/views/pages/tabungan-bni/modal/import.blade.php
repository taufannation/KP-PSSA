                ...
                <div class="row">
                    <div class="col-lg-12">
                        <small>* Tipe file yang diterima : <br>
                            .xlsx .csv</small> <br>
                        <a href="/template-kaskecil.xlsx" class="btn btn-primary mb-3">Download Template</a>
                    </div>
                    <div class="col-lg-12">
                        <form id="exform" action="{{ asset('kaskecil/import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
