<!-- Modal -->
<div class="modal fade" id="tabungan-bni_edit" data-backdrop="static" data-keyword="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
{{-- <script type="text/javascript">
        ...
        $('#form_edit').on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ asset('tabungan-bni/update/'. $data->id) }}",
data: idata,
processData: false,
contentType: false,
cache: false,
