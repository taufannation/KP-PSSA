<!-- Modal -->
<div class="modal fade" id="kategoritabungan_edit" data-backdrop="static" data-keyword="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
{{-- <script type="text/javascript">
        $('#form_edit').on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{ asset('kategoritabungan/update/'. $data->id) }}",
data: idata,
processData: false,
contentType: false,
cache: false,
