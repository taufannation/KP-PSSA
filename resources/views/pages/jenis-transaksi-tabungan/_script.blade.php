<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "{{ asset('jenis-transaksi-tabungan') }}",
                "type": "get",
            },
            columns: [{
                    data: 'DT_RowIndex',
    ...
    $('#data_form').on('submit', function(e) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ asset('jenis-transaksi-tabungan/store') }}",
            data: idata,
            processData: false,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                ...
                window.location.href = "{{ asset('jenis-transaksi-tabungan') }}"
                out_load();
            },
    ...
    function edit_data(id) {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ asset('jenis-transaksi-tabungan/edit') }}/" + id,
            data: {
                id: id,
                _token: token
            },
        ...
        $('#swal-update-button').click(function(e) {
            ...
            $.ajax({
                type: "PUT",
                dataType: "json",
                url: "{{ asset('jenis-transaksi-tabungan/update') }}/" + id,
                data: {
                    _token: token,
                    kode: $('#kode_edit').val(),
                    nama: $('#nama_edit').val(),
    ...
    function show_data(id) {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ asset('jenis-transaksi-tabungan/show') }}/" + id,
        ...
        swal({
            ...
            if (deleteFile) {
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ asset('/jenis-transaksi-tabungan/destroy') }}/" + id,
